...
class Net(torch.nn.Module):
    ...
    def _initialize_weights(self):
        ...
        torch.nn.init.kaiming_uniform_(self.hidden2.weight, mode='fan_in', nonlinearity='relu')
        torch.nn.init.zeros_(self.hidden1.bias)
        torch.nn.init.kaiming_uniform_(self.hidden3.weight, mode='fan_in', nonlinearity='relu')
        torch.nn.init.zeros_(self.hidden1.bias)
        torch.nn.init.kaiming_uniform_(self.predict.weight, mode='fan_in', nonlinearity='relu')
        torch.nn.init.zeros_(self.hidden1.bias)
...
def NN_train(train,test,lr,num_iterations):
    ...
    base_path       = './False/Re100_100episode_False_42_He'
